...
import br.com.fogliato.model.core.domain.converters.TipoAtividadeConverter;
...
@NamedQueries({
	...
	@NamedQuery(name = Atividade.NQ_ATIVIDADES_CONCLUIDAS,
		query = "SELECT a FROM Atividade a WHERE a.dataConclusao IS NOT NULL ORDER BY a.dataCriacao"
	)	
})
@Entity
